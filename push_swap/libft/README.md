...
- yt videos: anyone that could answer the questions at the time. Every youtube video i could find about the argument, except the ones that were telling too much about the exercise.
...
apart from `when building main edge cases to test` or needed a schedule, or remembrances